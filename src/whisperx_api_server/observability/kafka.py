...
late_reply_total: Any = _NoOpCounter()
pending_reaped_total: Any = _NoOpCounter()
dlq_total: Any = _NoOpCounter()
idempotent_skip_total: Any = _NoOpCounter()
handoff_total: Any = _NoOpCounter()
lease_deferred_total: Any = _NoOpCounter()
